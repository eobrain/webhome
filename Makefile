COMPILEJS=java -jar tools/closure/closure-compiler-v20190929.jar -O ADVANCED

COMPILED=sw.js _includes/home.js _includes/post.js _includes/post_blocking.js
